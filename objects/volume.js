...
X.volume.prototype.slicing_ = function() {
  ...
  for (xyz = 0; xyz < 3; xyz++) {
    ...
    if (true) {
      ...
      //attach labelmap
      if(this.hasLabelMap){
        var _sliceLabel = X.parser.reslice2(parseInt(currentIndex, 10),_sliceOrigin, this._childrenInfo[xyz]._sliceXYSpacing, this._childrenInfo[xyz]._sliceNormal, this._childrenInfo[xyz]._color, this._BBox, this._labelmap._IJKVolume, this._labelmap, this._labelmap.hasLabelMap, this._labelmap._colortable._map);
      ...
      var _slice = X.parser.reslice2(parseInt(currentIndex, 10),_sliceOrigin, this._childrenInfo[xyz]._sliceXYSpacing, this._childrenInfo[xyz]._sliceNormal, this._childrenInfo[xyz]._color, this._BBox, this._IJKVolume, this, true, null);
...
X.volume.prototype.sliceInfoChanged = function(index){
  ...
  if(this.hasLabelMap) {
    ...
    var _sliceLabel = X.parser.reslice2(Math.floor(this._childrenInfo[index]._nb/2),this._childrenInfo[index]._sliceOrigin, this._childrenInfo[index]._sliceXYSpacing, this._childrenInfo[index]._sliceNormal, this._childrenInfo[index]._color, this._BBox, this._labelmap._IJKVolume, this._labelmap, this._labelmap.hasLabelMap, this._labelmap._colortable._map);
  ...
  var _slice = X.parser.reslice2(Math.floor(this._childrenInfo[index]._nb/2),this._childrenInfo[index]._sliceOrigin, this._childrenInfo[index]._sliceXYSpacing, this._childrenInfo[index]._sliceNormal, this._childrenInfo[index]._color, this._BBox, this._IJKVolume, this, true, null);
  ...
  setTimeout(function() {
    ...
    for (i = 0; i < 1*quarters; i++) {
      ...
      if(!goog.isDefAndNotNull(_child._children[i])){
        ...
        //attach labelmap
        if(this.hasLabelMap){
          var _sliceLabel = X.parser.reslice2(i,_sliceOrigin, this._childrenInfo[direction]._sliceXYSpacing, this._childrenInfo[direction]._sliceNormal, this._childrenInfo[direction]._color, this._BBox, this._labelmap._IJKVolume, this._labelmap, this._labelmap.hasLabelMap, this._labelmap._colortable._map);
          this._labelmap._children[direction]._children[i] = _sliceLabel;
          // add it to create the texture
          this._labelmap._children[direction].modified(true);
        }

        var _slice = X.parser.reslice2(i,_sliceOrigin, this._childrenInfo[direction]._sliceXYSpacing, this._childrenInfo[direction]._sliceNormal, this._childrenInfo[direction]._color, this._BBox, this._IJKVolume, this, true, null);
